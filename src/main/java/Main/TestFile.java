...
//            String filename = "D:/ABschlussArbeit/IDE_Project/IntelliJ_Workspace/Graph_Algorithm_Implementation/src/main/java/Testing/facebook_combined.txt";
        ...
        Path path = Paths.get("D:/ABschlussArbeit/IDE_Project/IntelliJ_Workspace/Graph_Algorithm_Implementation/src/main/java/Files/facebook_combined.txt");
...
//
////            TestFile p = gs.fromJson(toJjson, TestFile.class);
////            var json = JSON.stringify(eval("(" + str + ")"));
//
//            out.write(json + System.getProperty("line.separator"));
            out.close();
