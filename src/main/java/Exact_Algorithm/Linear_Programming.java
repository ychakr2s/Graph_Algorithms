...
//						System.out.print(" V[" + (i + 1) + "] = " + model.getValue(x[i][j]));
                        }
//					System.out.println();
                    }
                    ...
                    System.out.println();
//				for (int i = 0; i < n; i++) {
//					System.out.println("V" + i + " is colored with Color: " + colors.get(i));
//				}

                    resultColors = colors.stream().mapToInt(i -> i).toArray();
//                    System.out.println("THE RESULT IS:: " + computeResultsColors(resultColors));
//
//                    System.out.println("THE TEST IS: " + test(resultColors));
